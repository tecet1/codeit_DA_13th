...
제1종 오류는 위양성오류, 제2종 오류는 위음성오류로 제1종 오류가 좀 더 치명적이라고 할 수 있음. (신약개발 사례) 따라서 실제 가설검정 과정에서는 우선적으로 제1종 오류의 유의수준을 고정(일반적으로 0.05 = 5%)하여 통제한 뒤 제2종 오류의 유의수준을 검정함.

제1종 오류의 확률($\alpha$)은 1-신뢰수준과 같음.
